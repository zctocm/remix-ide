...
const themes = [
  {name: 'Dark', quality: 'dark', url: 'https://stackpath.bootstrapcdn.com/bootswatch/4.3.1/darkly/bootstrap.min.css'},
  {name: 'Light', quality: 'light', url: 'https://bootswatch.com/4/flatly/bootstrap.min.css'},
